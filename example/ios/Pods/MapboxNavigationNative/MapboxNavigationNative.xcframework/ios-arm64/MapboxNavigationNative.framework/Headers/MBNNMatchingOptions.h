 ...
 */
@property (nonatomic, readonly, getter=isUseOnlyPreloadedTiles) BOOL useOnlyPreloadedTiles;
 ...
 */
@property (nonatomic, readonly, getter=isAllowPartialMatching) BOOL allowPartialMatching;
